...
#ifndef _LJMD_POVTOOLS_CPP_
#define _LJMD_POVTOOLS_CPP_
...
//**********************************************************************************************
void povRayConfProp::setBGColor(FPTYPE rgbr,FPTYPE rgbg,FPTYPE rgbb)
{
   backGroundColor[0]=rgbr; backGroundColor[1]=rgbg; backGroundColor[2]=rgbb;
   return;
}
//**********************************************************************************************
void povRayConfProp::setAngView(FPTYPE av)
{
   angView=av;
   return;
}
//**********************************************************************************************
void povRayConfProp::setSkyCam(FPTYPE xx,FPTYPE yy,FPTYPE zz)
{
   skyCam[0]=xx; skyCam[1]=yy; skyCam[2]=zz;
   return;
}
//**********************************************************************************************
void povRayConfProp::setLocCam(FPTYPE xx,FPTYPE yy,FPTYPE zz)
{
   locCam[0]=xx; locCam[1]=yy; locCam[2]=zz;
   return;
}
//**********************************************************************************************
void povRayConfProp::setLookAtCam(FPTYPE xx,FPTYPE yy,FPTYPE zz)
{
   lookAtCam[0]=xx; lookAtCam[1]=yy; lookAtCam[2]=zz;
   return;
}
//**********************************************************************************************
void povRayConfProp::addLightSource(FPTYPE xx,FPTYPE yy,FPTYPE zz)
{
   FPTYPE **cpls;
   int cpnls;
...
//**************************************************************************************************
//*
void povRayConfProp::writeLightSource(ofstream &ofil,int is,FPTYPE intens,const char* opts)
{
   string thetabs;
   ofil << endl << "light_source {" << endl;
   currIndLev++; thetabs=indTabsStr(currIndLev);
